-- Migration 027: mentorias pagas com pagamento Pix via Stripe
...
CREATE INDEX IF NOT EXISTS idx_paid_mentorships_active_order
  ON public.paid_mentorships(is_active, sort_order, created_at);

CREATE INDEX IF NOT EXISTS idx_bookings_paid_mentorship
  ON public.bookings(paid_mentorship_id);

CREATE INDEX IF NOT EXISTS idx_payments_paid_mentorship
  ON public.payments(paid_mentorship_id);
