-- Migration: dicas fixas nao podem ser ocultadas.
...
DROP TRIGGER IF EXISTS prevent_fixed_tip_hiding ON public.tips;
...
DROP TRIGGER IF EXISTS prevent_fixed_tip_delete ON public.tips;
...
CREATE INDEX IF NOT EXISTS idx_tips_fixed_placement
  ON public.tips(is_fixed, placement);
