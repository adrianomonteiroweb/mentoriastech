...
export const MENTOR_NAME = "equipe MentoriasTech"
...
export function buildWhatsAppCorrectionLink(opts: {
  ...
  const message = `Olá, equipe MentoriasTech! Revisando as anotações da mentoria sobre "${topic}" do dia ${dateStr}, identifiquei um ponto que gostaria de corrigir ou esclarecer:`
