...
export function StatsCards({ mentorView = false }: StatsCardsProps) {
  ...
  const allCards = [
    ...
    { label: "Candidaturas", value: stats?.totalApplications, icon: MousePointerClick, color: "text-blue-400", mentorVisible: false },
    ...
    { label: "IA Curriculo", value: stats?.minhasMentoriasResumeToolUses, icon: FileText, color: "text-blue-400", mentorVisible: false },
